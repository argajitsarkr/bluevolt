...
function OrdersList() {
  ...
  if (loading) return <div className="mt-6 text-ink/60">Loading...</div>;
  if (orders.length === 0) return <div className="mt-8 card p-8 text-center text-ink/60">No orders yet.</div>;
  return (
